  ...
  <div style="width:100%; height:100%;">
    ...
    <div style="width:inherit">
        ...
        <v-dialog v-model="dialog" scrollable width= "100%">
            <v-card>
              ...
              <v-card-text>
                ...
                <br>
                <br>
                <strong>제 6 조 (이용신청의 승낙)</strong><br>
                ...
                <br>
                <br>
                <strong>제 7 조 (이용자정보의 변경)</strong><br>
                ...
                <br>
                <br>
                <strong>제 8 조 (사이트의 의무)</strong><br>
                ...
                <br>
                <br>
                <strong>제 10 조 (회원 아이디(ID)와 비밀번호 관리에 대한 회원의 의무)</strong><br>
                ...
                <br>
                <br>
                <strong>제 11 조 (서비스 제한 및 정지)</strong><b></b>
                ...
                <br>
                <br>
                <strong>제 15 조 (관할법원)</strong><br>
                서비스와 관련하여 사이트와 회원간에 분쟁이 발생할 경우 사이트의 본사 소재지를 관할하는 법원을 관할법원으로 합니다.</h5>
              </v-card-text>
              <v-divider></v-divider>
              <v-card-actions>
                <v-spacer></v-spacer>
                <button @click="handle_toggle2" type="button" style="background-color:#a0d469; border:2px #a0d469 solid; border-radius:5px; color:#fff; width:300px;">
                  확인
                </button>
              </v-card-actions>
            </v-card>
      ...
      <div style="width:inherit; position: fixed; bottom:0;">
        <button v-if='JoinBtn' style="width:inherit" class="btn-bottom" @click="$emit('signup', signupData)">가입하기</button>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    checkJoinForm() {
      if(this.signupData.email && this.signupData.password && this.isTerm && this.isConfirm
      && this.signupData.passwordConfirm && this.signupData.nickname && this.signupData.address && this.pwdSucMsg
...
Swal.fire({
  ...
  if (result.dismiss === Swal.DismissReason.timer) {
    ...
    checkEmailValidate() {
      if (this.signupData.email.length >= 14 && EmailValidator.validate((this.signupData.email)))
        { 
        this.emailSucMsg = true;
