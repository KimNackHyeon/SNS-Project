  ...
  <div class="user join wrapC" style="position: relative;">
    ...
    <div class="form-wrap">
      ...
      <div class="input-with-label">
        ...
        <button class="btn-bottom" style="border-radius: 10px; float: right; position: unset; margin: 0 0 10px;">인증</button>
        <button class="btn-bottom" @click="retry" style="border-radius: 10px; float: right; position: unset; margin: 0 0 10px; background-color: red;">재전송</button>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    retry() {
      ...
      var threeMin = 60 * 3,
      display = document.querySelector('#times');
      this.startTimer(threeMin, display);
