<template>
  <div style="height:100%; width:100%;">
    <div
      style="width:100%; height:17%; border-top: 1px solid rgba(128, 128, 128, 0.15); border-bottom: 1px solid rgba(128, 128, 128, 0.15); text-align:center; margin-bottom:-9px; "
    >
