    ...
    <div class="carousel-container" style="height:430px; width:100%;">
      <div class="carousel-slide" style="display: flex; overflow: hidden; margin-left:11px;">
        <div
          ...
          :key="index"
          style="width:300px; height:400px; margin:20px; margin-top:20px; box-shadow: #80808066 1px 1px 8px; float:left;"
        >
...
export default {
  ...
  methods: {
    ...
    modifyReciptComplete() {
      ...
      axios
        .post(`https://i3b301.p.ssafy.io:9999/food/api/food/api/feed/img`, formData, {
    ...
    updateData(data) {
      console.log(data);
      axios
        .put(`https://i3b301.p.ssafy.io:9999/food/api/food/api/feed/update`, data)
        .then((response) => {
          // console.log(response);
