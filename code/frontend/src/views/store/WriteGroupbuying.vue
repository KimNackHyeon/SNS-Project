    ...
    <div style="padding: 10px 20px">
      ...
      <div style="margin: 10px 0">
        ...
        <div style="overflow: hidden;">
          <input type="text" v-model="food" @click="getFood" class="setFood" placeholder="ex) 양파" style="float:left; width: 100%; height: 40px; text-align: center; font-size: 15px;">
        </div>
